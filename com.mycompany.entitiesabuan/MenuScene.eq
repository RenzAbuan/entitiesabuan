...
public class MenuScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		menu.move(0,0);
		text1.move(text1.get_width()*0.5,get_scene_height()*0.8);
	//	text1.move(text1.get_width()*0.5,get_scene_height()*0.8-text1.get_height()*0.5);
	}

	
	public void on_pointer_press(SEPointerInfo pi) {
		base.on_pointer_press(pi);
	    if(pi.is_inside(text1.get_width()*0.5,get_scene_height()*0.8-text1.get_height()*0.5,text1.get_width()*0.5+text1.get_width(),get_scene_height()*0.8+text1.get_height())) {
